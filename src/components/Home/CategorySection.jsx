    ...
    return(
        ...
        <div className="bg-amazon-bg/30 w-full flex justify-center text-center pb-10 px-6 lg:px-8">
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mt-7">
              {loadingProducts ?
                (
                  //Categories Skeleton
                  ...
                  categories.map((category, index) => (
                    category.count ? 
                      <a key={index} className="hover:shadow-md group p-5 w-[220px] lg:w-[280px] rounded-2xl bg-amazon-surface border border-amazon-border hover:border-amazon-orange flex flex-col items-center"
